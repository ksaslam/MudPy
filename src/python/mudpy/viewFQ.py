...
def plot_KLslip(home,project_name,run_name,mesh_name,fudge=0.3):
    ...
    for kfault in range(len(faults)):
        ...
        p1 = PatchCollection(patches,cmap=pqlx_colormap,lw=0.1, edgecolor = 'black')
        colors = fault[:,9]
        p1.set_array(colors)
        ...
        p2 = PatchCollection(patches,cmap=rise_times_colormap,lw=0.1, edgecolor = 'black')
        colors = fault[:,7]
        p2.set_array(colors)
        ...
        p3 = PatchCollection(patches,cmap=whitejet,lw=0.1, edgecolor = 'black')
        colors=fault[:,12]
        p3.set_array(colors)
